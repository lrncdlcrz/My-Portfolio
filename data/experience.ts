...
export const experience: ExperienceItem[] = [
  ...
  },
  {
    ...
    organization: "Open for Work",
    period: "Present",
    description:
      "Available for freelance web development projects, remote collaboration, and internship opportunities.",
    type: "current",
  },
  {
    ...
    period: "Future",
    description:
      "Working toward a junior/full stack engineering role where I can build production systems end to end.",
    type: "future",
  },
];
